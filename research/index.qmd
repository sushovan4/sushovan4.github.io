...
```{=html}
<p class="section-kicker">Nine preprints, thirteen journal papers, seven proceedings, one thesis.</p>
```

```{=html}
<aside class="colophon" style="margin-top: 2rem;">
  <span class="monogram">&#10086;</span>
  <p>The full account &mdash; nine preprints, thirteen journal papers, seven conference proceedings, and the Ph.D. thesis &mdash; lives on the <a href="publications/">publications page</a>. Anything missing or in error will be corrected by post: <a href="mailto:s.majhi@gwu.edu">s.majhi@gwu.edu</a>.</p>
</aside>
```
