...
<figure class="plate-spread">
  ...
  <figcaption>A finite, noisy sample of points in the plane and the embedded metric graph reconstructed from it&mdash;edges, vertices, branch structure.</figcaption>
</figure>
...
- ***[Vietoris&ndash;Rips Shadow for Euclidean Graph Reconstruction](https://arxiv.org/abs/2506.01603)***&mdash;with Rafal Komendarczyk and Atish Mitra; reconstruction guarantees under the Hausdorff noise model.
