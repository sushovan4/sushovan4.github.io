...
1. **Certified Topological Interaction in Neural Representations: Class Disentanglement Is Mostly Pairwise.** Preprint, 2026. [arXiv](https://arxiv.org/abs/2609.08561). Exact permutation tests, a separation certificate, and paired tests for comparative claims, across 111 networks and 52,650 measurements. Disentanglement is depth-graded and early; the joint entanglement of a class triple almost always sits below its strongest pair, in vision encoders and frozen language models alike. Building the test taught a lesson that outlives the invariant: the statistic must be scale-free, or the certificate certifies feature-norm dynamics instead.
