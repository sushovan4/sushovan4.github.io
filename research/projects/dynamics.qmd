...
<figure class="plate-spread">
  ...
  <figcaption>A non-linear time series and its persistence barcode: the bars are the topological features that the sliding window detects in phase space.</figcaption>
</figure>
