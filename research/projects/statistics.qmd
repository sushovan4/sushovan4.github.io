...
<div class="lede">
  ...
  <p>It completes a trilogy. <a href="https://arxiv.org/abs/2605.02836">PLACE</a> gave the representation and <a href="https://arxiv.org/abs/2605.04046">PALACE</a> the adaptive kernel; the inference theory makes both testable, with rates matched by minimax lower bounds. The same program reaches the Euler characteristic, where the object under test is the topological interaction of two point clouds.</p>
</div>
```
...
The methods on this page are only as useful as the code that runs them. [*Akriti*](https://akriti.io) is an open-source Python software project for statistically grounded topological data analysis: hypothesis tests, effect sizes, per-region significance, and sample-size calculation for persistence diagrams. It delegates the computation of persistence to the established engines&mdash;GUDHI and Ripser&mdash;rather than reimplementing them, and owns the inference. It is [on PyPI](https://pypi.org/project/akriti/).

It is built in the open by a student developer team, with a governed contribution process: onboarding documents, public design RFCs, code review, and credit. Software engineering, like proof writing, is taught by apprenticeship.
