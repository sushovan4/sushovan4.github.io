...
<figure class="plate-spread">
  ...
  <figcaption><b>A bipartite user&ndash;item graph</b>&mdash;a network whose topology (connectedness, loops, voids in the preference space) carries signal that ordinary matrix-factorisation and embedding pipelines discard.</figcaption>
</figure>
...
<p class="section-kicker">Three master's, one bipartite graph, several voids.</p>
```
